...
class FilmControllerTest {
    ...
    @Test
    public void whenRequestFilmListThenGetPageWithFilmsList() {
        FilmDto film1 = new FilmDto(1, "name1", "desc1", 1, "genre1", 1, 1, 1);
        FilmDto film2 = new FilmDto(2, "name2", "desc2", 2, "genre2", 2, 2, 2);

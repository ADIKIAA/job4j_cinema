...
public class Sql2oFilmRepository implements FilmRepository {
    ...
    public Collection<Film> findAll() {
        try (var connection = sql2o.open()) {
            ...
            return query.setColumnMappings(Film.COLUM_MAPPING).executeAndFetch(Film.class);
        }
    }
    ...
    public Optional<Film> findByName(String name) {
        try (var connection = sql2o.open()) {
            ...
            Film film = query.setColumnMappings(Film.COLUM_MAPPING).executeAndFetchFirst(Film.class);
